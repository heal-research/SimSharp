...
namespace SimSharp {
  /// <summary>
  /// The stack holds a variable number of individual items.
  /// The items are removed from the store in LIFO order.
  /// 
  ...
  public class Stack {
    ...
    protected Stack<StoreItem> Items { get; private set; }
